module deployer_address::dog_token_fa {
    use std::signer;
    ...
    const SEED: vector<u8> = b"DOG_TOKEN_FA";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store::create_primary_store_enabled_fungible_asset(
            ...
            DECIMALS,
            string::utf8(
                b"https://aqua-eligible-shrimp-69.mypinata.cloud/ipfs/bafkreicy4yzcshceaikz3zipu4azacjpybtgg5xh6wxw7r3hgdigy733ly"
            ),
